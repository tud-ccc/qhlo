...
// CHECK: %[[THETA:.*]] = arith.divf %[[PI1]], %[[TWO]] : f64
// CHECK: %[[PHI:.*]] = arith.constant 0.000000e+00 : f64
// CHECK: %[[LAMBDA:.*]] = arith.constant 3.1415926535897931 : f64
...
// CHECK: %[[CQ:.*]], %[[TQ:.*]] = "quantum.CNOT"(%[[UQ0]], %[[Q0]]#1) : (!quantum.qubit<1>, !quantum.qubit<1>) -> (!quantum.qubit<1>, !quantum.qubit<1>)
...
// CHECK-NEXT: }) : () -> ()
// CHECK-NEXT: }
// CHECK-NEXT: func.func @qasm_main() {
// CHECK-NEXT: qpu.execute @qasm_generated::@main ins () outs ()
// CHECK-NEXT: return
// CHECK-NEXT: }
// CHECK-NEXT: }
